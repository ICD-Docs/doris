...
![Imagen de captura de pantalla de DORIS versión en línea ](img/DORISwebjune25.png)
...
El botón **formulario de ejemplo** proporciona casos que demuestran cómo funciona la versión en línea de DORIS. Los usuarios pueden consultar estos casos demuestra para saber cómo utilizar la versión en línea.
